...
Defining a custom theme to adhere to styles.css in 009_report. 
...
It's commented out because the model has already been fit and saved as an RDS file, which is loaded in the next code chunk for further analysis.
