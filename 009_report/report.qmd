...
![Vote Percentages for Dialysis Regulation in California](../007_visualizations/Yes_Vote_Percentages_Propositions_in_Californa.png){width=90%}
...
This project employs an innovative approach to examine a matter of significant public interest, with implications extending beyond California to the entire nation. Over the past decade, investigative journalists, patient advocacy groups, and labor organizations have invested considerable resources to heighten public awareness about the dialysis industry and the perceived need for increased regulation.
