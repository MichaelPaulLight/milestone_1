...
This half-eye plot (also known as a ridgeline plot) displays the posterior distributions of the model parameters.
...
![Posterior Predictive Check for Entire Model](../007_visualizations/pp_check.png){width=90%}
