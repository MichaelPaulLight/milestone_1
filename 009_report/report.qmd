...
R was chosen for this analysis because of its integration with the STAN probabilistic programming language and suite of tools used to visualize uncertainty and Bayesian model outputs. Alternatives in the Python ecosystem would include PyMC3 and ArviZ, but the R ecosystem is, in general, more mature for Bayesian/multi-level modeling and uncertainty visualization.
